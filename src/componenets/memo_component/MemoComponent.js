...
const MemoComponent = ({
  ...
  const removeMemo = () => {
    if (!isMobile) {
      ...
      if (removeConfirm) {
        axios
          .delete(`https://api.friendrive.net/record/${memo_id}`, {
            headers: {
      ...
      <div className={style.memoBox_top}>
        <div className={style.memo_iconBox}>
          <div
            ...
            style={{
              backgroundImage: `url(${is_feedback ? teacher : memo})`,
