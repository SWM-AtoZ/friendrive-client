...
const Detail = () => {
  ...
  useEffect(() => {
    ...
    const remainSpace = Math.round(
      document.getElementById("topNavi").getBoundingClientRect().height
    );
    const content_height =
      Math.round(
        document.getElementById("detail_section").getBoundingClientRect().height
      ) -
      remainSpace -
      30;
