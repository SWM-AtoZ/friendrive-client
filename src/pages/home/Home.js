...
function Home() {
  ...
  return (
    <section id={style.home_section}>
      ...
      <button ref={Curriculum_btnRef} onTouchStart={()=>{Curriculum_btnRef.current.style.backgroundColor='rgba(0, 0, 0, 0.05)'}} onTouchEnd={()=>{Curriculum_btnRef.current.style.backgroundColor='#F8FBFC'; 
      goToCurriculum();}} onClick={()=>{if(!isMobile){goToCurriculum()}}} className={style.curriculum_btn}>
