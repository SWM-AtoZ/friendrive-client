    ...
    <section className={style.navi_section}>
      <div id="topNavi" className={style.topNavi}>
        ...
        >
          ...
          >
            <path
              d="M7.40991 10.5898L2.82991 5.99976L7.40991 1.40976L5.99991 -0.000244141L-8.7738e-05 5.99976L5.99991 11.9998L7.40991 10.5898Z"
              fill="black"
            />
          </svg>
        </div>
        <div className={style.naviTitle}>피드백</div>
        <button onClick={sendFeedback} className={style.wiriting_complete}>
          보내기
        </button>
      </div>
      <article className={style.writing_area_box}>
        ...
        <input
          id="teacherName"
          className={style.teacherName_input}
          type="text"
          placeholder="선생님의 이름을 입력해주세요 (필수)"
          value={teacherName}
        ...
        <textarea
          ...
          onChange={Write}
          value={feedbackText}
          placeholder={`${studentName}님에게 보낼 피드백을 적어주세요`}
        ></textarea>
      </article>
      <Outlet />
    </section>
